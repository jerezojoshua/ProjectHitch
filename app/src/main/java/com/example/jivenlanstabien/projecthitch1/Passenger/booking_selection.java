...
public class booking_selection extends AppCompatActivity
{
    ...
    TextView lblPUP2DOFF, lblDateAndTime, lblLuggage;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        lblLuggage = (TextView) findViewById(R.id.lblluggage);
        ...
        /*tvSeat5 = (TextView) findViewById(R.id.tvseat5);
        tvSeat6 = (TextView) findViewById(R.id.tvseat6);
        tvSeat7 = (TextView) findViewById(R.id.tvseat7);*/
        ...
        /*x5 = (CheckBox) findViewById(R.id.x5);
        x6 = (CheckBox) findViewById(R.id.x6);
        x7 = (CheckBox) findViewById(R.id.x7);*/
    ...
    private void showTrips(String json){
        try {
           ...
           /* String seat5 = c.getString(DriverConfig.TAG_TR_SEAT5);
            String seat6 = c.getString(DriverConfig.TAG_TR_SEAT6);
            String seat7 = c.getString(DriverConfig.TAG_TR_SEAT7);*/
            ...
            /*tvSeat5.setText(seat5);
            tvSeat6.setText(seat6);
            tvSeat7.setText(seat7);*/
    ...
    /*private void updateSeat5(){
        final String seat5 = r;
        class UpdateSeat5 extends AsyncTask<Void,Void,String>{
            ProgressDialog loading;
            @Override
            protected void onPreExecute() {
                super.onPreExecute();
            ...
            protected String doInBackground(Void... params) {
                HashMap<String,String> hashMap = new HashMap<>();
                hashMap.put(DriverConfig.KEY_TRP_TRPID,tripid);
                hashMap.put(DriverConfig.KEY_SEAT5_STATUS,seat5);

                RequestHandler rh = new RequestHandler();
                String s = rh.sendPostRequest(DriverConfig.URL_UPDATE_SEAT5,hashMap);
                return s;
            }
        }
        UpdateSeat5 usi = new UpdateSeat5();
        usi.execute();
    }

    private void updateSeat6(){
        final String seat6 = r;
        class UpdateSeat6 extends AsyncTask<Void,Void,String>{
            ProgressDialog loading;
            @Override
            protected void onPreExecute() {
                super.onPreExecute();
            ...
            protected String doInBackground(Void... params) {
                HashMap<String,String> hashMap = new HashMap<>();
                hashMap.put(DriverConfig.KEY_TRP_TRPID,tripid);
                hashMap.put(DriverConfig.KEY_SEAT6_STATUS,seat6);

                RequestHandler rh = new RequestHandler();
                String s = rh.sendPostRequest(DriverConfig.URL_UPDATE_SEAT6,hashMap);
                return s;
            }
        }
        UpdateSeat6 usi = new UpdateSeat6();
        usi.execute();
    }

    private void updateSeat7(){
        final String seat7 = r;
        class UpdateSeat7 extends AsyncTask<Void,Void,String>{
            ProgressDialog loading;
            @Override
            protected void onPreExecute() {
                super.onPreExecute();
            ...
            protected String doInBackground(Void... params) {
                HashMap<String,String> hashMap = new HashMap<>();
                hashMap.put(DriverConfig.KEY_TRP_TRPID,tripid);
                hashMap.put(DriverConfig.KEY_SEAT7_STATUS,seat7);

                RequestHandler rh = new RequestHandler();
                String s = rh.sendPostRequest(DriverConfig.URL_UPDATE_SEAT7,hashMap);
                return s;
            }
        }
        UpdateSeat7 usi = new UpdateSeat7();
        usi.execute();
    }*/
