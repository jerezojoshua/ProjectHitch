...
public class AddSchedule extends AppCompatActivity {
    ...
    CheckBox cbx;
    Button btnAddSched;
    EditText etPickUp, etDropOff, etTime, etNoDays, etNoWeeks, etLuggage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etLuggage = (EditText) findViewById(R.id.luggage_provision);
    ...
    public void clickAddSched(View v) {
        ...
        luggage = etLuggage.getText().toString();
    ...
    public void addTrips(){
        ...
        if (cbMonday.isChecked()) {
            ...
            /*if (seat5.equals("yes")) {trSeat5 = "Available";} else {trSeat5 = "Not Available";}
            if (seat6.equals("yes")) {trSeat6 = "Available";} else {trSeat6 = "Not Available";}
            if (seat7.equals("yes")) {trSeat7 = "Available";} else {trSeat7 = "Not Available";}*/
